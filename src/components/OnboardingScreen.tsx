    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#F5F5F5] p-6">
      <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md">
        <div className="flex flex-col items-center text-center">
          ...
          <h1 className="text-2xl font-bold text-[#2C4A3E]">
            Welcome to GreenBot
          </h1>
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            <label
              htmlFor="apiKey"
              className="block text-sm font-medium text-[#2F3635]"
            >
              Enter your API key
            </label>
            <Input
              ...
              className={cn(
                "border-[#8BA888] focus-visible:ring-[#98C9A3]",
        ...
        <div className="pt-4 mt-6 text-xs text-center text-gray-500 border-t border-gray-200">
          <p>
